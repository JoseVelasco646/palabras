...
/////////////////////////////////////////////////////////////////////////  lo obtube de un repositorio
///////////////////////////////////////////////////////////                 y solo le implemente el input
/////////////////////////////////////////////////////////////
...
(function () {
    ...
    function acentuacion() {
        ...
        switch (silaba.numeroSilaba - silaba.tonica) {
            case 0:
                silaba.acentuacion = 'Aguda y lleva acento en la ultima silaba tonica' ;
                break;
            case 1:
                silaba.acentuacion = 'Grave (Llana) y lleva acento en la penultima silaba tonica';
                break;
            case 2:
                silaba.acentuacion = 'Esdrújula y lleva acento en la antepenultima silaba tonica ';
                break;
            default:
                silaba.acentuacion = 'Sobresdrújula y lleva acento en la antes de la antepenultima silaba tonica';
                break;
        }
    ...
    if (typeof global.silabaJS === 'undefined')
    global.silabaJS = silabaJS;
    function obtenerSilabasUsuario() {
        const rl = readline.createInterface({
            input: process.stdin,
            output: process.stdout
        });
    
        rl.question('Ingresa la palabra para separar por sílaba tónica: ', (palabra) => {
            const resultado = getSilabas(palabra);
            console.log('Sílabas tónicas de la palabra:', resultado);
            if(palabra=='exit')
        {
            rl.close();
        }else {
            obtenerSilabasUsuario(palabra)
    ...
    // Llamada a la función para que el usuario ingrese la palabra
    obtenerSilabasUsuario();
